...
\subsubsection{Multi-$k$ k-Distance}
...
\subsubsection{Top-$K$ Rank Fusion}
...
Table~\ref{tab:final_detector_performance} shows the validation performance of key individual detectors in our final ensemble, while Table~\label{tab:baseline_comparison} in the Experiments section provides a detailed baseline comparison.
